(function() {
  ...
  init = function(json) {
    ...
    */
    var container, i, index, index2, j, le, len, len1, pageComp, pageHead, pageHeadLabel, phone, pl, ref, ref1, subPage, value, value2;
    container = new Layer({
      width: 334,
      height: 680,
      borderRadius: 50
...
//# sourceMappingURL=array_alt.js.map
